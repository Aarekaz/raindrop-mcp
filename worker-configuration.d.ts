/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=wrangler-types.env` (hash: e4858d720af86b0db082b8cbeb6de133)
// Runtime types generated with workerd@1.20260611.1 2026-06-12 nodejs_compat
interface __BaseEnv_Env {
	RAINDROP_AUTH_KV: KVNamespace;
	ASSETS: Fetcher;
	JWT_ISSUER: "https://raindrop-mcp.aarekaz.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ISSUER" | "JWT_ACCESS_TOKEN_EXPIRY" | "JWT_REFRESH_TOKEN_EXPIRY">> {}
}
